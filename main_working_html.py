...
def download_newsletter(text):
    with open('rewritten_newsletter.txt', 'w') as file:
        file.write(text)
        st.markdown(
            f"Download [rewritten_newsletter.txt](rewritten_newsletter.txt)")
    return
...
if st.button("Generate Newsletter"):
    ...
    try:
        ...
        newsletter_html = BeautifulSoup(rewritten_newsletter,
        ...
        if rewritten_newsletter:
            st.button("Download Newsletter",
                      on_click=download_newsletter,
                      args=((newsletter_html, )))
    except Exception as e:
